  ...
  return (
    <div id="about" className="flex flex-col items-center justify-center min-h-0 bg-black pt-10 pb-10">
      <div className="text-center text-white">
        ...
        {
          isMobile ?
            <img src="https://i.ibb.co/pKnTSVM/kg-RM9xj-Y-400x400.jpg" alt="WOOF Logo" className="inline h-64" />
          :
            <video 
        ...
        <p className="font-courier text-6xl mb-8 text-emerald-500">$EGGDOG TOKEN</p>
