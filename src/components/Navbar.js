    ...
    <nav className="bg-black py-4">
      <div className="container mx-auto flex justify-between items-center px-4 xl:px-0">
        <a href="/" className="flex items-center">
          <img src="https://i.ibb.co/pKnTSVM/kg-RM9xj-Y-400x400.jpg" alt="WOOF Logo" className="h-12" />
        </a>
        <div className="flex items-center">
          ...
          <a href="https://t.me/eggdogtoken" target="_blank" rel="noopener noreferrer" className="text-white px-3">
